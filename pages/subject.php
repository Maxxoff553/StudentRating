    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="subject.php" class="nav-link px-2 text-white" id="subject_page">Предметы</a></li>
        </ul>
      </div>
    </div>
  </header>
        ...
        <table class="table shadow table-bordered mt-4 text-center">
          ...
          <tbody>
            <?php foreach ($page_data as $res) { ?>
              <tr>
                <td>
                  <?php echo $res->subject_id; ?>
                </td>
                <td>
                  <?php echo htmlspecialchars($res->subject_name); ?>
                </td>
                <td>
                  <a href="?id=<?php echo $res->subject_id; ?>" class="btn btn-success" data-bs-toggle="modal"
                    data-bs-target="#edit<?php echo $res->subject_id; ?>">Изменить</a>
                  <a href="" class="btn btn-danger" data-bs-toggle="modal"
                    data-bs-target="#delete<?php echo $res->subject_id; ?>">Удалить</a>
                </td>
              </tr>
              <!--Окно обновления строки-->
              <div class="modal fade" id="edit<?php echo $res->subject_id; ?>" tabindex="-1"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="?id=<?php echo $res->subject_id; ?>" method="post">
                        <div class="form-group">
                          <small>Название предмета</small>
                          <input type="text" class="form-control" name="subject_name"
                            value="<?php echo $res->subject_name; ?>">
              ...
              <div class="modal fade" id="delete<?php echo $res->subject_id; ?>" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">
                        Удалить запись №<?php echo $res->subject_id; ?>
                      </h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-footer">
